...
const Nav = () => {
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between px-6 py-3 text-white">
      <SiSpacex className="text-3xl mix-blend-difference bg-black" />
      <button
        onClick={() => {
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        opacity,
        backgroundImage:
          "url(https://static01.nyt.com/images/2023/09/20/multimedia/19bizsky-google-bard-print/19GOOGLE-BARD-top-hpgz-articleLarge.jpg?quality=75&auto=webp&disable=upscale",
